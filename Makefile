TITLE_ID = VPKINSTAL
TARGET = VpkDirectInstallerModEng
...
LIBS = -lSceDisplay_stub -lSceSysmodule_stub -lSceCtrl_stub -lSceNet_stub \
...
$(TARGET).vpk: eboot.bin
	vita-mksfoex -s TITLE_ID=$(TITLE_ID) "VPK Direct InstallerMod" param.sfo
